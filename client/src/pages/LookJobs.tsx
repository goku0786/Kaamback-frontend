        ...
        <div className="container mt-5 mx-auto px-4 md:px-8 lg:px-16">
          <div className="py-10">
            ...
            <div className="flex flex-col md:flex-row gap-8 ">
              {/* Filters Section */}
              <div className="bg-gray-100  p-10 rounded-lg w-full  lg:w-1/3 md:mx-10  border ">
              ...
              <div className="w-full md:w-1/2 space-y-10 ">
                ...
                {jobs.map((job) => (
                  <div
                    key={job._id}
                    className="bg-gray-100 p-5 rounded-lg flex md:flex-row justify-between items-center"
                  >
